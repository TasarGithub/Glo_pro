...
let myText = myBook[4].innerHTML.replace('Пропопипы','Прототипы');
...
let ul2 = myBook[0].querySelectorAll('ul'),
...
let ul5 = myBook[5].querySelectorAll('ul'),
...
let ul6 = myBook[2].querySelectorAll('ul'),
